...
export const validationSchemeEmployeeInformation = Yup.object({
  ...
  phoneNumber: Yup.string().matches(/^\d{8,11}$/, 'Phone number should have 10 or 13 digits include the nation code')
...
export const validationSchemeEmployeeEmergencyContact = Yup.object({
  ...
  phoneNumberPrimary: Yup.string().matches(/^\d{8,11}$/, 'Phone number should have 10 or 13 digits include the nation code')
    .required('Phone number is required')
    .typeError('Phone number should be a number'),
