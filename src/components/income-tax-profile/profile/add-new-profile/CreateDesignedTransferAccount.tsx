...
export default function CreateDesignedTransferAccount() {
  ...
  const validationSchema = Yup.object({
    ...
    bank: Yup.string().required().required("Required!"),
    bankAccountHolders: Yup.string().required("Required!"),
    bankAccountNo: Yup.string().required("Required!"),
    bankCode: Yup.string(),
    branchCode: Yup.string(),
    branchName: Yup.string(),
    swiftCode: Yup.string(),
    notes: Yup.string().max(100, "Max. 100 Character"),
  });
          ...
          <Box component="div" sx={{ marginTop: "17px" }}>
            <Paper component="div" sx={{ padding: "16px" }}>
              ...
              >
                ...
                >
                  The Designated Transfer Account is added manually to each
                  employee's profile
                </Typography>
              </Box>
              ...
              >
                ...
                <Box sx={{ width: { xs: "100%", md: "50%" } }}>
                  ...
                  <Input
                    ...
                    required
                    onChange={(e) =>
                      formik.setFieldValue("bankAccountHolders", e.target.value)
                    }
                    sx={{
                      color: "#6B7280",
                      borderColor: "#E5E7EB",
                  ...
                  />
                  {formik.touched.bankAccountHolders &&
                  formik.errors.bankAccountHolders ? (
                    <Typography sx={{ color: "#DC2626" }}>
                      {formik.errors.bankAccountHolders}
                    </Typography>
                  ) : null}
              ...
              >
                <Box sx={{ width: { xs: "100%", md: "50%" } }}>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      formik.setFieldValue("bankAccountNo", e.target.value)
                    }
                    required
                    sx={{
                      color: "#6B7280",
            ...
            >
              <Button variant="outlined" label="Back" sx={{ width: "63px" }} />
              <Button
                color="primary"
                label="Next"
                sx={{ width: "63px" }}
