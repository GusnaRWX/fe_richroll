...
import ItpCreateBasicDetailComponent from './ItpCreateBasicDetailComponent';
...
export default function ItpCreateNewComponentComponent() {
    ...
    <>
      ...
      <Paper sx={{ width: '100%', p: '21px 8px' }}>
        ...
        <TabPanel value={value} index={1}>
          <ItpCreateDesignedTransferAccountComponent setValue={setValue} />
        </TabPanel>
