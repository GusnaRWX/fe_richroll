...
interface PendingLeaveSummaryTableProps {
  tabValue: number;
}

type Order = "asc" | "desc";

function PendingLeaveSummaryTable({ tabValue }: PendingLeaveSummaryTableProps) {
...
export default PendingLeaveSummaryTable;
