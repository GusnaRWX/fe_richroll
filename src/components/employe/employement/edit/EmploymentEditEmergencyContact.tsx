...
import { validationSchemeEmployeeEmergencyContact } from '@/components/employees/create/validate';
...
interface EmergencyContactProps {
  ...
  setValues: React.Dispatch<React.SetStateAction<Employment.EmergencyContactPatchValues>>;
  emergencyValues: Employment.EmergencyContactPatchValues;
  handleThirdEmergency: () => void
}

function EmploymentEditEmergencyContact({ refProp, setValues, emergencyValues, handleThirdEmergency }: EmergencyContactProps) {
...
export default EmploymentEditEmergencyContact;